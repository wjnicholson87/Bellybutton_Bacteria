...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var gaugeData = [ {
      domain: { x: [0, 1], y: [0, 1] },
      value: freq,
      title: { text: "<b>Belly Button Washing Frequency <br>(Scrubs per Week)", font: { size: 15 } },
      type: "indicator",
      mode: "gauge+number",
      gauge: {
        bar: {color: 'black'},
        ...
        { range: [4, 6], color: 'rgb(248, 252, 28)' },
        { range: [6, 8], color: 'rgb(151, 242, 76)' },
        { range: [8, 10], color: 'rgb(57, 120, 3)' },
        ]
      }
    }
    ];  
